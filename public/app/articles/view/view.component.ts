...
@Component({
	selector: 'view',
	templateUrl: 'app/artices/view/view.template.html',
})
...
export class ViewComponent {
	...
	constructor(private _router:Router, private _route: ActivatedRoute, private _authenticationService: AuthenticationService, private _articlesService: ArticlesService) {}
